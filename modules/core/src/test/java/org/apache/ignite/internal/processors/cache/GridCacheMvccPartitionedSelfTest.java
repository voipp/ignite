...
public class GridCacheMvccPartitionedSelfTest extends GridCommonAbstractTest {
    ...
    public void testSerializableReadLocksAdd() throws Exception {
        ...
        GridCacheVersion serOrder1 = new GridCacheVersion(0, 10, 1, true);
        GridCacheVersion serOrder2 = new GridCacheVersion(0, 20, 1, true);
        GridCacheVersion serOrder3 = new GridCacheVersion(0, 15, 1, true);
    ...
    private void checkNonSerializableConflict() throws Exception {
        ...
        GridCacheMvccCandidate cand2 = mvcc.addLocal(e,
            ...
            version(2),
            0,
            new GridCacheVersion(0, 0, 1, true),
            false,
            true,
            false,
            true,
    ...
    private void checkSerializableAdd(boolean incVer) throws Exception {
        ...
        GridCacheVersion serOrder2 = new GridCacheVersion(0, 20, 1, true);
        GridCacheVersion serOrder3 = new GridCacheVersion(0, 15, 1, true);
        GridCacheVersion serOrder4 = new GridCacheVersion(0, 30, 1, true);
    ...
    private GridCacheVersion version(int order) {
        return new GridCacheVersion(1, order, order, 0, null, true);
    }
