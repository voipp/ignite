...
public class GridCacheMvccSelfTest extends GridCommonAbstractTest {
    ...
    public void testRemotes() {
        ...
        entry.orderCompleted(
            new GridCacheVersion(1, 2, 0, false),
            Arrays.asList(new GridCacheVersion(1, 3, 4, false), ver2, new GridCacheVersion(1, 5, 6, false)),
    ...
    public void testLocalAndRemote() {
        ...
        entry.orderCompleted(
            ver2 /*local version.*/,
            Arrays.asList(new GridCacheVersion(1, 1, 2, false), ver3, new GridCacheVersion(1, 5, 6, false)),
            Collections.<GridCacheVersion>emptyList()
        );
    ...
    private GridCacheVersion version(int order) {
        return new GridCacheVersion(1, order, order, false);
    }
